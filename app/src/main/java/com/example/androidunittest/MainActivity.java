...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mSharedPreferenceHelper = new SharedPreferencesHelper(sharedPreferences);
    ...
    private void populateUI() {
        ...
        sharedPreferenceEntry = mSharedPreferenceHelper.getPersonalInfo();
        mNameText.setText(sharedPreferenceEntry.getName());
        Calendar dateOfBirth = sharedPreferenceEntry.getDateofBirth();
        mDobPicker.init(dateOfBirth.get(Calendar.YEAR), dateOfBirth.get(Calendar.MONDAY),dateOfBirth.get(Calendar.DAY_OF_MONTH), null);
    ...
    public void onSaveClick(View view){
        ...
        boolean isSuccess = mSharedPreferenceHelper.savePersonalInfo(sharedPreferenceEntry);
        if(isSuccess){
